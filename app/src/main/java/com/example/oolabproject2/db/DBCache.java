...
// ------------------------------------->
    ...
    {
        Logger.getLogger("DBCache: Request to cache month: "+date);
    ...
    {
        Logger.getLogger("DBCache: Refreshing for day: "+date);
    ...
    public void wipeAll()
    {
        Logger.getLogger("DBCache: Refreshing all");
    ...
    private class LoadMonthRunnable implements Runnable
    {
        ...
        public void run()
        {
            ...
            try
            {
                ...
                Logger.getLogger("DBCache: Caching data for month: "+month);
                ...
                Logger.getLogger("DBCache: Data cached for month: "+month);
            }
            finally
            {
                if( db != null )
    ...
    private class LoadBalanceMonthRunnable implements Runnable
    {
        ...
        public void run()
        {
            ...
            try
            {
                ...
                Logger.getLogger("DBCache: Caching balance data for month: "+month);
                ...
                Logger.getLogger("DBCache: Data balance cached for month: "+month);
            }
            finally
            {
                if( db != null )
